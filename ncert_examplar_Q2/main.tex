...
\item \begin{table}[!htb]
	...
	\caption{Two coin toss}
	\label{table3:ncert/11/16/3/17/}	
\end{table} 
\begin{align}
	P_{X}(1) &= \frac{1}{2}\\
	P_{X}(2) &= \frac{1}{4}\\
...
\begin{align}
	...
	p &= \frac{3}{26}
\end{align}
\item The $Z$-transform of a die is defined as
\begin{align}
...
\begin{align}
M_{X_2}(z) =  \frac{1}{6}\sum_{n = 1}^{6}z^{-n}
=\frac{z^{-1}{(1-z^{-6})}}{6{(1-z^{-1})}}, {|z|} > 1
\end{align}
...
\begin{align}
  M_X(z) = \frac{z^{-1}{(1-z^{-6})}}{6{(1-z^{-1})}} \times \frac{z^{-1}{(1-z^{-6})}}{6{(1-z^{-1})}}
\\
  M_X(z) = \frac{1}{36}\left[\frac{z^{-2}{(1-2z^{-6}+z^{-12})}}{{(1-z^{-1})}^2}\right]
\end{align}
...
\begin{multline}
\frac{1}{36}[{(n-1)u(n-1)}
{-2(n-7)u(n-7)+(n-13)u(n-13)}]
\xleftrightarrow{Z}
\frac{1}{36} \left[{\frac{z^{-2}{1-2z^{-6}+z^{-12}}}{({1-z^{-1}})^2}}\right]
\end{multline}
