...
\begin{align}
	...
	f(\epsilon_{k}) &= \frac{1}{\sigma \sqrt{2\pi}} e^{\frac{-1}{2}\frac{(\epsilon_{k}-0)^2}{\sigma^2}}\\
	\text{Likelihood function}: f(\epsilon_{1}\epsilon_{2}....\epsilon_{n}) &= \prod_{k = 1}^{n} f(\epsilon_{k})\\
	L &= \prod_{k = 1}^{n}\frac{1}{\sigma \sqrt{2\pi}}e^{\frac{-1}{2}\frac{(\epsilon_{k})^2}{\sigma^2}}\\
	  &= \brak{\frac{1}{\sigma \sqrt{2\pi}}}^n e^{\brak{\frac{-1}{2} \sum_{k = 1}^{n} \frac{(\epsilon_{k})^2}{\sigma^2}}}\\
	  &= \brak{\frac{1}{\sigma \sqrt{2\pi}}}^n e^{\brak{\frac{-1}{2\sigma^2} \sum_{k = 1}^{n} \brak{y_{k}-\alpha_{0}-\alpha_{1} \log_{e}k}^2}}\\
L_{1} = \ln L&= -\frac{n}{2}\ln 2\pi - \frac{n}{2}\ln\sigma^2 - \frac{1}{2\sigma^2} \sum_{k = 1}^{n} \brak{y_{k}-\alpha_{0}-\alpha_{1} \log_{e}k}^2\\  
	L_{1} &= \text{function of }\alpha_{0}, \alpha_{1} \\
	\frac{\partial L_{1}}{\partial \alpha_{0}} &= -\frac{1}{\sigma^2} \sum_{k = 1}^{n} \brak{y_{k}-\alpha_{0}-\alpha_{1} \log_{e}k} = 0\\
	...
	\frac{\partial L_{1}}{\partial \alpha_{1}} &= -\frac{1}{\sigma^2} \sum_{k = 1}^{n} \brak{y_{k}-\alpha_{0}-\alpha_{1} \log_{e}k}\log_{e}k = 0\\
	\implies \tilde{\alpha_{1}} &= \frac{\sum_{k = 1}^{n}\brak{\log_{e}k-\bar{x}}\brak{y_{k}-\bar{y}}}{\sum_{k = 1}^{n}\brak{\log_{e}k-\bar{x}}^2} 
\end{align}
$\because$ Maximum likelihood estimator of $\alpha_{0}$ and $\alpha_{1}$ exist\\
$\therefore$ Option \brak{A} and \brak{B} are incorrect\\
The least square estimator of $\alpha_{0}$ is $\tilde{\alpha_{0}}$ and is unique\\
The least square estimator of $\alpha_{1}$ is $\tilde{\alpha_{1}}$ and is unique\\
$\therefore$ Option \brak{D} is incorrect\\
$\therefore$ Option \brak{C} is correct
\end{document}
