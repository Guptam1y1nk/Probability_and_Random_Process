...
From question 1.3.3 we know the equation of altitudes B$E_{1}$ and C$F_{1}$ now to find the point of intersection H of altitudes we need to solve these two equations simultaneously\\
Equation of B$E_{1}$\\
\begin{align}
...
\begin{align}
        ...
        \myvec{1&1&2\\0&-12&10}\\
        R_{2} \rightarrow \frac{R_{2}}{-12}\\
        \myvec{1&1&2\\0&1&\frac{-5}{6}}\\
        R_{1} \rightarrow R_{1} - R_{2}\\
        \myvec{1&0&\frac{17}{6}\\0&1&\frac{-5}{6}}\\
\end{align}
        Therefore point of intersection H is
\begin{align}
        \vec{x}&=\myvec{\frac{17}{6}\\\frac{5}{6}}\\
               &=\myvec{2.833\\-0.833}
\end{align}
\end{document}
